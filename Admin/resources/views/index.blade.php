            ...
            <div class="carousel-item active">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                      <img style="width:600px" src="{{ asset('front end/images/image3.jpeg') }}" alt="" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p1.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Ring
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p2.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Watch
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p3.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Teddy Bear
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p4.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Flower Bouquet
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p5.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Teddy Bear
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p6.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Flower Bouquet
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p7.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Watch
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{ asset('front end/images/p8.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Ring
