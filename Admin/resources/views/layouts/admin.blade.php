    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          ...
          <div class="title">
            <h1 class="h5">{{ Auth::user()->name ?? 'Admin' }}</h1>
        ...
        <ul class="list-unstyled">
                ...
                <li class="{{ Request::is('admin/products*') ? 'active' : '' }}"><a href="{{ route('admin.products.index') }}"> <i class="icon-grid"></i>Products </a></li>
                <li class="{{ Request::is('admin/categories*') ? 'active' : '' }}"><a href="{{ route('admin.categories.index') }}"> <i class="icon-interface-windows"></i>Categories </a></li>
                <li class="{{ Request::is('admin/orders*') ? 'active' : '' }}"><a href="{{ route('admin.orders.index') }}"> <i class="icon-padnote"></i>Orders </a></li>
        </ul>
        {{-- <ul class="list-unstyled">
